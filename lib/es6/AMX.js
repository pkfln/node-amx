...
import { AMX_MAGIC, AMX_FLAG_COMPACT, AMX_CELL_SIZE, AMX_COMPACTMARGIN, AMX_MIN_FILE_VERSION, AMX_CUR_FILE_VERSION, BYTE_SIZE, } from './constants';
var AMX = /** @class */ (function () {
    function AMX(buffer) {
        ...
        var amxHeader = new AMXHeader(buffer);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        fd = _b.sent();
                        return [4 /*yield*/, fs.read(fd, Buffer.alloc(BYTE_SIZE), 0, BYTE_SIZE, 0)];
                    case 3:
                        _a = _b.sent(), bytesRead = _a.bytesRead, buffer = _a.buffer;
                        if (!(bytesRead < BYTE_SIZE)) return [3 /*break*/, 5];
                        return [4 /*yield*/, fs.close(fd)];
                    case 4:
                        _b.sent();
                        throw new Error('File size is less than AMX header size.');
                    case 5:
                        amxHeader = new AMXHeader(buffer);
